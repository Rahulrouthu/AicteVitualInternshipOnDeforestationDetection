...
model = joblib.load("C:/Users/routh/Downloads/best_fire_detection_model.pkl")
scaler = joblib.load("C:/Users/routh/Downloads/FinalWeekProjectOFFireClassification/scaler.pkl")
